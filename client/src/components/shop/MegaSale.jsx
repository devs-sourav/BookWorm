...
import { FaChevronLeft, FaChevronRight, FaSearch, FaTimes, FaFilter, FaSortAmountDown } from "react-icons/fa";
...
const MegaSale = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setAllProduct([...processedProducts].reverse());
      setFilteredProducts([...processedProducts].reverse());
    } catch (err) {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 flex items-center gap-2">
                🔥 <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">Mega Sale</span>
              </h1>
    ...
    <div className="mt-12 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        <div className="text-sm text-gray-600">
          ...
          <span className="font-semibold text-gray-800">{totalProducts}</span> results
        </div>
        <div className="text-sm text-gray-600">
