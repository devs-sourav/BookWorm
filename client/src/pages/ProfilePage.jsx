...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://bookworm-t3mi.onrender.com/api/v1/auth/me/${id}`, {
          method: 'GET',
          headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://bookworm-t3mi.onrender.com/api/v1/auth/update-profile/${id}`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleCropComplete = async (croppedBlob) => {
    ...
    try {
      ...
      const uploadResponse = await fetch(`https://bookworm-t3mi.onrender.com/api/v1/auth/update-profile/${id}`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`
