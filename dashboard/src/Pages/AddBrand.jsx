                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="relative ">
                    ...
                    <input
                      ...
                      className="w-full dark:bg-gray-800 bg-white pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="px-4 py-2 dark:bg-gray-800 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                  ...
                  <select
                    ...
                    className="px-4 py-2 border dark:bg-gray-800 bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 dark:bg-gray-800 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors"
                  >
                    Clear Filters
                  </button>
                </div>
                        ...
                        {filteredBrands.length === 0 ? (
                          ...
                          filteredBrands.map(brand => (
                            <tr key={brand._id} className="hover:bg-gray-50">
                              ...
                              <td className="border border-gray-200 px-4 py-3">
                                <p className={`px-2 py-1 rounded-full !text-white text-center text-xs font-medium ${
                                  brand.isActive 
